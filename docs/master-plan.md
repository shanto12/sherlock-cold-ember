...
- Accessibility contract: normal document scroll, no sound, no gore, no flashing, keyboard/touch parity, persistent motion pause, and a composed reduced-motion edition
...
- Bounded animation lifecycle, visibility pausing, image priority, responsive crops, and no layout overflow
...
- Public v1.0.0 release only after all required rows are proven
